...
{ 
  ...
  if(k>0) example_kmeans(nrow-1, ncol-1, D, k, r, distmetric, jobname);
   ...
   gcc -Wall -g -Wno-unused Aclustering.c cluster.c -o Aclustering -Inifti/niftilib -Inifti/nifticdf -Inifti/znzlib -L. -l3DEdge -lmri -lf2c -lmri /usr/lib64/libXm.a -lXm -lXmu -lXpm -lXext -lXt -lX11 -lz -lexpat -lm -lc
